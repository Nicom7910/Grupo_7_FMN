window.onload = function(){
    ...
    description.addEventListener('keydown', (e) => {
        descriptionLength.innerHTML = 1000 - description.value.length
        if(description.value.length >= 1000 && e.key != 'Backspace'){
            e.preventDefault()
        }
    })
    ...
    form.addEventListener('submit', e => {
        ...
        //chequeamos que el admin este subiendo una foo del producto
        if(image.value == ''){
            errors++
